...
async def analyze_trading_signals(df,
    ...
    {{
        ...
        3. По каким причинам ты поставил точку входа
        ",
    ...
    Не ставь стоп лос просто чтобы "спасти баланс" приведи аргументы с индикаторов и сигналов или новостей
    То же самое каается с точкой входа, определии ее на и объясни на основе новостей и сигналов с индикатора 
