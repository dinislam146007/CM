...
Если хоть одна из следующих ситуаций верна, верни строго `null` без какого-либо форматирования:
- Новость **очень похожа** на старую (по смыслу, а не только по словам).
...
"""
    ...
    response = await client.chat.completions.create(
        ...
        max_tokens=512,  # Уменьшил, чтобы ответы были короче
    )
